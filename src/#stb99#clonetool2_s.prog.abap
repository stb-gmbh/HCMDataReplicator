...
SELECTION-SCREEN COMMENT 5(20) text-b2a FOR FIELD p_b2a.
SELECTION-SCREEN COMMENT 28(10) text-beg.
PARAMETERS p_b2begd TYPE dats DEFAULT '18000101'.
SELECTION-SCREEN COMMENT 50(10) text-end.
PARAMETERS p_b2endd TYPE dats DEFAULT '99991231'.
SELECTION-SCREEN END OF LINE.

PARAMETERS: p_uvm TYPE /stb99/ct2_cust_uvm AS CHECKBOX.
PARAMETERS: p_rvBEA TYPE /stb99/ct2_cust_rvBEA AS CHECKBOX.
PARAMETERS: p_BEA TYPE /stb99/ct2_cust_BEA AS CHECKBOX.
